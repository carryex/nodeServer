...
// Take a given string and a date object and find/replace all the keys within it
helpers.interpolate = (str, data) => {
  ...
  // For each key in the data object , inset its value into the string at the corresponding placeholder
